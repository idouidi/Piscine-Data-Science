...
attr1, attr2 = 'Empowered', 'Prescience'
jedi = df_train_scaled[df_train['knight'].str.strip() == 'Jedi']
sith = df_train_scaled[df_train['knight'].str.strip() == 'Sith']

plt.figure(figsize=(8, 6))
plt.scatter(sith[attr1], sith[attr2], color='#E85D75', label='Sith', alpha=0.6)
plt.scatter(jedi[attr1], jedi[attr2], color='#6495ED', label='Jedi', alpha=0.6)
plt.xlabel(f'{attr1}')
plt.ylabel(f'{attr2}')
